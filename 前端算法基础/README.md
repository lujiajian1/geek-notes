...
var longestValidParentheses = function(s) {
    ...
    for(let i=0;i<len;i++) {
        if(s[i]==='(') {
            ...
            stack.pop();let stack_len = stack.length;
            if(stack_len===0) {
                stack.push(i);
            } else {
...
![链表](https://github.com/lujiajian1/geek-notes/blob/main/img/linked.jpg)
```js
/**
...
![哈希表](https://github.com/lujiajian1/geek-notes/blob/main/img/hash.jpg)
```js
/**
...
* 树里面没有环路(cycle)。
![树](https://github.com/lujiajian1/geek-notes/blob/main/img/tree.jpg)
#### 常见术语
...
![树](https://github.com/lujiajian1/geek-notes/blob/main/img/tree1.jpg)
注意： 关于满二叉树定义这里，国内外定义有分歧，本文采用的是国内定义。满二叉树英文是 Full Binary Tree，是指所有的节点的度只能是0或者2。 如下图，国外也认为是Full Binary Tree：
![树](https://github.com/lujiajian1/geek-notes/blob/main/img/tree2.jpg)
...
![树](https://github.com/lujiajian1/geek-notes/blob/main/img/tree3.jpg)
#### 最大堆
